...
# def config_setup(audio_dir, filename, num_speakers=None) -> None:
#     """
#     Changes audio manifest file
#     Arguments:
...
#     def diarize(self, audio_dir, filename, num_speakers=None):
#         # setup manifest file
#         config_setup(audio_dir, filename, num_speakers)
